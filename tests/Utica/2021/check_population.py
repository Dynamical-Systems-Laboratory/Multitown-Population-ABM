...
file_age_dist = '../../../town_data/Utica/census_data/age_distribution.txt'
# File with age distribution of the household head
file_hs_age = '../../../town_data/Utica/census_data/age_household_head.txt'
# File with household size distribution
file_hs_size = '../../../town_data/Utica/census_data/household_size.txt'
