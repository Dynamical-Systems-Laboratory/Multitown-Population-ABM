...
# ------------------------------------------------------------------
#
# Generate Colonie population for the COVID model
#
# ------------------------------------------------------------------
...
dpath = '../../../town_data/Colonie/database/'
cpath = '../../../town_data/Colonie/census_data/'
year = '2021'
...
pb_file_gis = dpath + year + '_core_poi_ColonieIn_WorkTrimmed.csv'
# File with regular workplaces inside (with occupation)
pb_file_in = dpath + year + '_core_poi_ColonieIn_OccupationTrimmed.csv'
# File with public places GIS data that are outside (with occupation)
pb_file_out = dpath + year + '_core_poi_ColonieOut_WorkTrimmed.csv'
# File with building types
pb_type_file = dpath + 'public_types_mobility.txt'
# File with leisure inside of town
pb_leisure_file_in = dpath + year + '_core_poi_ColonieIn_LeisureTrimmed.csv'
# File with leisure outside of town
pb_leisure_file_out = dpath + year + '_core_poi_ColonieOut_LeisureTrimmed.csv'
...
rh_out = 'Colonie_retirement_homes.txt'
hs_out = 'Colonie_households.txt' 
wk_out = 'Colonie_workplaces.txt'
hsp_out = 'Colonie_hospitals.txt'
sch_out = 'Colonie_schools.txt'
ag_out = 'Colonie_agents.txt'
cpool_out = 'Colonie_carpool.txt'
public_out = 'Colonie_public.txt'
leisure_out = 'Colonie_leisure.txt'
